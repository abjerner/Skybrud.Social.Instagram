namespace Skybrud.Social.Instagram.BasicDisplay.Fields {
    ...
    public class InstagramUserFields {
        ...
        /// The User's ID.
        /// </summary>
        public static readonly InstagramField Id = new("id");

        /// <summary>
        /// TTe User's account type. Can be <c>BUSINESS</c>, <c>MEDIA_CREATOR</c>, or <c>PERSONAL</c>.
        /// </summary>
        public static readonly InstagramField AccountType = new("account_type");
        ...
        /// </summary>
        public static readonly InstagramField MediaCount = new("media_count");

        /// <summary>
        /// A list of Media on the User.
        /// </summary>
        public static readonly InstagramField Media = new("media");
