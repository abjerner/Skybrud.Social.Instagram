...
namespace Skybrud.Social.Instagram.Exceptions {
    ...
    /// </summary>
    public class InstagramOAuthForbiddenException : InstagramOAuthException {
        ...
        public InstagramOAuthForbiddenException(IHttpResponse response, InstagramMetaData meta) : base(response, meta) { }
