...
using Skybrud.Social.Instagram.Options.Graph.Users;
using Skybrud.Social.Instagram.Responses.Graph.Media;
using Skybrud.Social.Instagram.Responses.Graph.Users;
...
namespace Skybrud.Social.Instagram.Endpoints.Graph {
    ...
    public class InstagramUsersEndpoint {
        ...
        /// </summary>
        public InstagramUsersRawEndpoint Raw => Service.Client.Graph.Users;
